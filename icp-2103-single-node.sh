...
: '
    ...
    README: This script installs a single node of ICP 2.1.0.3,
            you need to set the ICP_FILE_URL accordingly to
            ensure you can download/copy the offline package
            from the right place.

            In order to use this script, can run it without
            any parameter or execute it setting the public ip
            as a parameter.

            Example: ./icp-2103-single-node.sh 1.2.3.4 (assuming 1.2.3.4
